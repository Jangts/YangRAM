...
echo '<section class="ic section bg-light"><div class="ic blank-30"></div><div class="ic w1200 bg-white grid-21" style=" box-shadow: 0px 0px 5px #CCC"><div class="nm-5"><div><div class="nav-left">栏目导航</div><ul class="nav-left-list"><li class="';
...
echo '"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/publications/category/3/">《校友风采》</a></li></ul></div></div><div class="nm-half">&nbsp;</div><div class="nm-15"><div class="ic blank-30"></div><header class="ft-18 lh-21 ft-modena"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
...
echo '</a></header><div class="ic blank-10"></div><ul class=" " id="news-list">';
