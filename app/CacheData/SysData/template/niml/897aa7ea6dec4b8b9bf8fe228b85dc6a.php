...
echo '"><a href="';
echo $REQUEST->DIR;
echo 's/stunews/category/27/">学院校友会</a></li><li class="';
if( isset($__Columns[2]) && $__Columns[2] == 'category28' ){
	echo 'actived';
}
echo '"><a href="';
echo $REQUEST->DIR;
echo 's/stunews/category/28/">校友会快讯</a></li><li class="';
if( isset($__Columns[2]) && $__Columns[2] == 'category32' ){
	echo 'actived';
}
echo '"><a href="';
echo $REQUEST->DIR;
echo 's/students/category/32/">优秀校友</a></li><li class="';
if( isset($__Columns[2]) && $__Columns[2] == 'category29' ){
	echo 'actived';
}
echo '"><a href="';
echo $REQUEST->DIR;
echo 's/stunews/category/29/">校友捐赠</a></li><li class="';
