...
echo '<section class="ic section bg-light"><div class="ic blank-30"></div><div class="ic w1200 pa-20 bg-white grid-21" style=" box-shadow: 0px 0px 2px #DDD"><div class="nm-5"><div class="side-list-title">栏目导航</div><ul class="side-list"><li class="actived"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/stunews/">校友之家</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/students/">创业之星</a></li></ul></div><div class="nm-1">&nbsp;</div><div class="nm-15 main-container"><div class="ic blank-10"></div><header><span class="dir"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/stunews/">校友之家</a></span></header><div class="ic blank-10"></div><ul id="mylist" class="ic listview text-list" data-ic-auto="true" data-list-cols="1">';
foreach($___LIST as $index => $item){
	echo '<li class="list-item pane"><a href="';
	echo $REQUEST->REST_HANDLER_DIR;
	echo 's/stunews/article/';
