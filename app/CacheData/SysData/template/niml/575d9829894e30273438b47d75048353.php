...
echo $__SRCDIR;
echo 'stylesheets/list.css"><link type="text/css" rel="stylesheet" href="';
echo $__AF_SRCDIR;
echo 'Interblocks/see/ListView/style.css"></head><body>';
...
echo 's/enrollment/category/1/">本科生</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/enrollment/category/2/">专科生</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/enrollment/category/3/">继续教育</a></li><li class="actived"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
...
echo $REQUEST->REST_HANDLER_DIR;
echo 's/enrollment/">招生就业</a><i>/</i><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/jiuyes/">就业信息</a></span></header><div class="ic blank-10"></div><ul id="mylist" class="ic listview media-list" data-ic-auto="true">';
