...
echo '<section class="ic section bg-light"><div class="ic blank-30"></div><div class="ic w1200 pa-20 bg-white grid-21" style=" box-shadow: 0px 0px 2px #DDD"><div class="ic blank-10"></div><ul id="mylist" class="ic listview text-list" data-ic-auto="true" data-list-cols="2">';
foreach($___LIST as $index => $item){
	echo '<li class="list-item pane"><a href="';
	echo $REQUEST->REST_HANDLER_DIR;
	echo 's/chuangs/article/';
...
echo '<li class="list-item" onclick="window.location.href=\'?page=';
echo $pages["l"];
echo '\'">&gt;&gt;</li></ul></div><div class="ic blank-50"></div></section>';
