...
echo '<section class="ic section bg-light"><div class="ic blank-30"></div><div class="ic w1200 pa-20 bg-white grid-21" style=" box-shadow: 0px 0px 2px #DDD"><div class="ic blank-10"></div><article class="news-content"><header>';
echo $___TITLE;
...
echo '</div></div></div><div class="ic blank-50"></div></section>';
