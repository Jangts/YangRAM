...
echo $REQUEST->REST_HANDLER_DIR;
echo 's/news/category/20/">媒体建筑</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/news/category/1/">抬头看路</a></li></ul></div><div class="nm-1">&nbsp;</div><div class="nm-15 main-container"><div class="ic blank-10"></div><header><span class="dir"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/news/">学院动态</a><i>/</i><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/';
echo $___PRESET_ALIAS;
echo '/">通知公告</a></span></header><div class="ic blank-10"></div><ul id="mylist" class="ic listview text-list" data-ic-auto="true" data-list-cols="1">';
