...
echo 's/stunews/">校友之家</a></span></header><article class="news-content"><header>';
echo $___TITLE;
...
echo '</div></div></div><div class="nm-1">&nbsp;</div><div class="nm-5"><div class="side-list-title">栏目导航</div><ul class="side-list"><li class="actived"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/stunews/">校友之家</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/students/">创业之星</a></li></ul></div></div><div class="ic blank-50"></div></section>';
