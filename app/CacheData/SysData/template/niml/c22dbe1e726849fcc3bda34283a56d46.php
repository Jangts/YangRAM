...
echo 's/stunews/">校友之家</a></li><li class="actived"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
...
echo $REQUEST->REST_HANDLER_DIR;
echo 's/students/">创业之星</a></span></header><div class="ic blank-10"></div><ul id="mylist" class="ic listview text-list" data-ic-auto="true" data-list-cols="1">';
foreach($___LIST as $index => $item){
	echo '<li class="list-item pane"><a href="';
	echo $REQUEST->REST_HANDLER_DIR;
	echo 's/students/article/';
