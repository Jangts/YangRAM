...
echo '"><a href="';
echo $REQUEST->DIR;
echo 'g/departments/article/jzsyzx.html">工程实验中心</a></li></ul></div><div class="nm-1">&nbsp;</div><div class="nm-15 main-container"><div class="ic blank-10"></div><header><span class="dir"><a href="';
echo $REQUEST->DIR;
echo 'g/departments/article/tmgcx.htm">机构设置</a><i>/</i>';
echo $___TITLE;
echo '</span></header><article class="news-content">';
