...
echo 'g/about/article/index.html">学院简介</a></li><li class="actived"><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/leadership/">现任领导</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 's/teachers/">教师风采</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
echo 'g/about/article/majors.html">专业介绍</a></li><li class=""><a href="';
echo $REQUEST->REST_HANDLER_DIR;
...
echo $REQUEST->REST_HANDLER_DIR;
echo 's/leadership/">现任领导</a></span></header><div class="ic blank-10"></div><ul id="mylist" class="ic listview media-list teachers" data-ic-auto="true" data-list-cols="3">';
