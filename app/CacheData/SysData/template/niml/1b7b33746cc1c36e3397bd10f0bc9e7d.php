...
echo $REQUEST->DIR;
echo 's/stunews/category/28/">校友会快讯</a></li><li class="actived"><a href="';
echo $REQUEST->DIR;
echo 's/students/category/32/">优秀校友</a></li><li class=""><a href="';
echo $REQUEST->DIR;
echo 's/stunews/category/29/">校友捐赠</a></li><li class=""><a href="';
echo $REQUEST->DIR;
...
echo $REQUEST->DIR;
echo 's/students/category/32/">优秀校友</a></span></header><div class="ic blank-10"></div><ul id="mylist" class="ic listview media-list teachers" data-ic-auto="true" data-list-cols="3">';
