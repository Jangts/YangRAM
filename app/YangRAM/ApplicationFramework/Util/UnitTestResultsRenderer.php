...
HEAD;
    ...
    private static function getTestFooter($testcount, $use){
        ...
        $foot .= '<script src="'.NIAF_PID.'Sources/tweenlite.min.js"></script>';
        $foot .= '<script src="'.NIAF_PID.'Sources/easepack.min.js"></script>';
        $foot .= '<script src="'.I4S_PID.'Sources/testing.js"></script></body></html>';
        return $foot;
    }
