...
iBlock([
    ...
    _.extend(_.dom, {
        cache: function(elem) {
            if (elem) {
                return elem.InterblocksUID = elem.InterblocksUID || cache.save({});
            }
        }
    });
    ...
    _.extend(_.dom, true, {
        ...
        events: {
            fire: function(elem, event, eventType) {
                elem.InterblocksUID && cache.read(elem.InterblocksUID).Events && cache.read(elem.InterblocksUID).Events.fire(event, eventType);
                return this;
            },
            ...
            remove: function(elem, eventType, selector, handler) {
                if (elem.InterblocksUID && cache.read(elem.InterblocksUID).Events) {
                    var Events = cache.read(elem.InterblocksUID).Events;
                    if (handler) {
                        ...
                        if (eventType && typeof selector != 'undefined') {
                            ...
                            if (eventType) {
                                ...
                                Events.remove();
                                elem.InterblocksUID.Events = undefined;
                                delete elem.InterblocksUID.Events;
                            }
                        }
                    }
                }
