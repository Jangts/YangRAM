 ...
 */
;
iBlock(['$_/util/str.xtd', '$_/util/arr.xtd', '$_/util/obj.xtd'], function(pandora, global, undefined) {
    var _ = pandora,
    ...
    /**
     * Sub Selectors And Other Auxiliary Methods Of Interblocks Selector
     * ------------------------------------------------------------------
     */
