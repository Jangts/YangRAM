        ...
        if (_.util.bool.isSupportCanvas()) {
            ...
            var setSafeDataURI = function(successCallback, failCallback) {
                ...
                if (that.isSupportDataURI === null) {
                    ...
                    el.onerror = error;
                    el.onload = success;
                    el.src = "data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDInterblocksE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg=="; // the Image contains 1px data.
                    return;
