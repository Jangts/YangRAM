...
final class SystemDict extends Dictionary {
	public static function getLang($lang){
		$lang_check_result = $GLOBALS['NEWIDEA']->check_lang(PATH_LANGS.'{{lang}}', true, $lang);
