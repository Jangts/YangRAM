<?php
namespace System\STAT;
use Exception;
use System\R5\Response;
use System\R5\Request;
...
final class Status extends Exception {
	...
	TEMP_GREEN_CHANNEL 	= PATH_SYS.'STAT/Templates/200.php',
	TEMP_400 			= PATH_SYS.'STAT/Templates/400.php',
	TEMP_YELLOW 		= PATH_SYS.'STAT/Templates/400.php',
	TEMP_404 			= PATH_SYS.'STAT/Templates/404.php',
	TEMP_ALPHA_CHANNEL 	= PATH_SYS.'STAT/Templates/404.php',
	TEMP_700 			= PATH_SYS.'STAT/Templates/700.php',
	TEMP_NACARAT 		= PATH_SYS.'STAT/Templates/700.php',
	TEMP_701 			= PATH_SYS.'STAT/Templates/701.php',
	TEMP_RED 			= PATH_SYS.'STAT/Templates/701.php',
	TEMP_707 			= PATH_SYS.'STAT/Templates/707.php',
	TEMP_AZURE			= PATH_SYS.'STAT/Templates/707.php',
	TEMP				= PATH_SYS.'STAT/Templates/707.php',
	TEMP_708 			= PATH_SYS.'STAT/Templates/708.php',
	TEMP_MAGENTA		= PATH_SYS.'STAT/Templates/708.php',
	TEMP_SERVER_ERRORS 	= PATH_SYS.'STAT/Templates/797.php';

	public static $sattuscodes = null;

	public static function init(){
		if(self::$sattuscodes===null){
			if(is_file(PATH_SYS.'STAT/codes.json')){
				self::$sattuscodes = json_decode(file_get_contents(PATH_SYS.'STAT/codes.json'), true);
			}else{
