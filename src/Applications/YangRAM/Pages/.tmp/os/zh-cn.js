RegApplication(3, (__thisapp__, YangRAM, Using, Global, undefined) => {
'use strict';
const __LANG__ = {
    "CODE": "zh-cn",
    "APPNAME": "我的页面",
...
const __APPDIR__ = '/Applications/YangRAM/Pages/';
const $ = YangRAM.$;
...
const pm_591955eea0fb8 = {
	};
const pm_591955eea0fbe = {
...
YangRAM.extends(__thisapp__, true, pm_591955eea0fbe);
